...
public interface SV {
    ...
    @GET("/getTKSV")
    Call<ArrayList<TKSinhVien>> getTK();
    @GET("/getKhoa")
    Call<ArrayList<Khoa>> getKhoa();
    @GET("/getNienKhoa")
    Call<ArrayList<NienKhoa>> getNienKhoa();
    @POST("/sv/insert")
    Call<sinhVienClass> insertSV(@Body sinhVienClass sv);
    @POST("/hp/insert")
    Call<HP> insertHP(@Body HP hp);
    @POST("/cthp/insert")
    Call<chitietHP> insertCTHP(@Body chitietHP cthp);

    @POST("/tksv/insert")
    Call<TKSinhVien> insertTKSV(@Body TKSinhVien tksv);

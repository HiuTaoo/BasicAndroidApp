...
public class LichHocFragment extends Fragment {
    ...
    ArrayList<HP> arrChitietHP, arrLH;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        hpAdapter= new HPAdapter(getActivity(), R.layout.hp_items, arrChitietHP);
            ...
            public void onResponse(Call<ArrayList<HP>> call, Response<ArrayList<HP>> response) {
                if (response.isSuccessful()) {
                    ...
                    sv.get_KQDK_By_ID(mainActivity.getID().toString()).enqueue(new Callback<ArrayList<HP>>() {
                        ...
                        public void onResponse(Call<ArrayList<HP>> call, Response<ArrayList<HP>> response) {
                            if (response.isSuccessful()) {
                                arrChitietHP = response.body();
                                hpAdapter = new HPAdapter(getActivity(), R.layout.course_items, arrChitietHP);
